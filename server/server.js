...
app.use(
  cors({
    origin: ["https://www.untangled-ai.com", "https://main.untangled-ai.com", "https://backend.untangled-ai.com"],
    credentials: true,
  })
);
...
app.get("/user-info", async (req, res) => {
  ...
  try {
    const me = await google.people({ version: "v1", auth: oAuth2Client }).people.get({

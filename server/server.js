...
app.get("/oauth2callback", async (req, res) => {
  ...
  try {
    ...
    console.log("Tokens retrieved:", tokens.access_token);
    ...
    console.log("Tokens stored in session:", req.session.tokens.access_token);
    ...
    req.session.save((err) => {
      ...
      const redirectUrl = "http://localhost:3001/home?auth=success";

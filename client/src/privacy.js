        ...
        >
            ...
            <div className="pl-5">
              <ul className=" list-disc">
                ...
                <li>
                  ...
                  "Our" in this Agreement) refers to Untangled.
                </li>
                <li>
                ...
                <li>
                  Website refers to Untangled, accessible from
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div>
                <text className="font-bold text-2xl">Law enforcement</text>
              </div>
              <p>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5">
              <li>By email: kyle.untangled@gmail.com</li>
              <li>By visiting this page on our website: untangled.cardd.co</li>
            </ul>
          </div>
        </div>
      </div>

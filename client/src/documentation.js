        ...
        >
          <div className={`w-full m-10 sxl:mt-11 xsm:mt-20 `}>
            ...
            <div className="xsm:w-5/6 mt-7 text-xl font-semibold sxl:w-4/5">
              <text>
                Ethan is an AI assistant that can help you plan your schedules
                and set up meetings through a chat-like interface.
              </text>
            </div>
            <div className="my-4 text-xl font-semibold">
              <text className="underline">Suggested Prompts</text>
            </div>
